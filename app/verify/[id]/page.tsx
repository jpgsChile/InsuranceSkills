...
export default function VerifyPage() {
  ...
  const finalVerificationUrl = verificationUrl || (typeof window !== 'undefined' ? window.location.href : `/verify/${encodeId(credencial.id)}`)
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-6">
          ...
          <p className="text-sm text-gray-600 text-center">
            Escanea este código QR para acceder a esta verificación
          </p>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-semibold text-green-900 mb-2">
                Credencial Verificable y Auténtica
              </h4>
              <p className="text-sm text-green-800">
                Esta credencial es <strong>verificable, no editable y emitida por la institución</strong>. 
                La Escuela de Seguros de Chile garantiza la autenticidad de esta credencial mediante 
                estándares internacionales de credenciales verificables (W3C Verifiable Credentials).
              </p>
            </div>
          </div>
        </div>
