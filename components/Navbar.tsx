...
export default function Navbar() {
  ...
  const navLinks = role === 'alumno' 
    ? [
        { href: '/dashboard', label: 'Mis Cursos' },
        { href: '/wallet', label: 'Mi Wallet' },
      ]
    : [
        { href: '/institucion/dashboard', label: 'Panel de Control' },
        { href: '/institucion/credenciales', label: 'Credenciales Emitidas' },
      ]
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex">
              <Link 
                href={role === 'alumno' ? '/dashboard' : '/institucion/dashboard'} 
